...
NEW_ROXY_DIR="${ROXY_ROOT:-$HOME/.roxy}"
...
# Check if ${ROXY_ROOT:-$HOME/.roxy} exists
if [ -d "$NEW_ROXY_DIR" ]; then
    warn "Existing ${ROXY_ROOT:-$HOME/.roxy}/ detected"
...
#!/bin/bash
#===============================================================================
# Migrate ~/.roxy/ to ${ROXY_ROOT:-$HOME/.roxy}/
...
OLD_ROXY="$HOME/.roxy"
NEW_ROXY="${ROXY_ROOT:-$HOME/.roxy}"
BACKUP_DIR="${ROXY_ROOT:-$HOME/.roxy}-backup-$(date +%Y%m%d-%H%M%S)"
...
echo "Migrating ~/.roxy/ to ${ROXY_ROOT:-$HOME/.roxy}/..."
...
echo "[2/4] Ensuring ${ROXY_ROOT:-$HOME/.roxy}/ structure..."
