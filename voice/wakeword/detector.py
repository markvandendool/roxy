...
Uses OpenWakeWord with hey_jarvis as interim until custom Hey Roxy is trained
"""
import asyncio
import numpy as np
...
class WakeWordDetector:
    ...
    async def listen(self):
        ...
        try:
            ...
            logger.info('🎧 Listening for wake word (say "Hey Jarvis")...')
            stream.start_stream()
...
async def main():
    ...
    print('Say "Hey Jarvis" to trigger (interim wake word)')
