...
# Configuration
WATCH_DIR="/opt/roxy/content-pipeline/input"
WORK_DIR="/opt/roxy/content-pipeline/work"
OUTPUT_DIR="/opt/roxy/content-pipeline/output"
LOG="/var/log/roxy/content-pipeline.log"
ERR_LOG="/var/log/roxy/content-pipeline.err"
PROCESSED_LOG="/tmp/roxy_content_processed.txt"

# Pipeline scripts
TRANSCRIBER="/opt/roxy/content-pipeline/transcriber.py"
VIRAL_DETECTOR="/opt/roxy/content-pipeline/viral_detector.py"
CLIP_EXTRACTOR="/opt/roxy/content-pipeline/clip_extractor.py"
...
if ! command -v inotifywait &> /dev/null; then
    ...
    sudo apt-get install -y inotify-tools 2>> "$ERR_LOG"
fi
