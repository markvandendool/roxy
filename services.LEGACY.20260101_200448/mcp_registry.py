...
MCP_BASE_DIR = "/opt/roxy/mcp-servers"
REGISTRY_FILE = "/opt/roxy/config/mcp-registry.json"
...
class MCPRegistry:
    ...
    def save_claude_config(self, output_path: str = None):
        ...
        if output_path is None:
            output_path = "/opt/roxy/config/claude-mcp.json"
...
def main():
    ...
    print(f"  - /opt/roxy/config/claude-mcp.json")
