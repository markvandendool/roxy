...
# Infisical
INFISICAL_HOST=secrets.jarvis.local
INFISICAL_API_URL=https://secrets.jarvis.local/api
...
- Secrets stored in Infisical (secrets.jarvis.local)
